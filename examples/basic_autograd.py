...
print(f"    ONE neuron with 784 inputs builds:")
print(f"      {stats['nodes']:>7,} nodes")
print(f"      {stats['edges']:>7,} edges")
print(f"      {stats['depth']:>7,} deep  ← the recursive topological sort would")
print(f"                        die here; ours is iterative (decision D5)")
print(f"\n    A 784→128→64→10 network has 109,386 parameters.")
print(f"    Every one of them is a Python object, in a graph rebuilt per sample.")
print(f"    That is the measurement that motivates Phase 18 (tensors).")
